  ...
  let html_content = `
    <!--macro custom styles-->
      <style>  
        ...
        label.sb_bug_report_label_radio:hover {cursor: pointer;box-shadow: 0 0 5px darkred;}
    ...
    <fieldset style="text-align: left;display:inline;width:49%">
      ...
      <label class="sb_bug_report_label" for="sb_bug_report_sys_info_active_module_count">Active Modules</label>
