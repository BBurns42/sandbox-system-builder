export const SETTINGATTRIBUTE={  
  ...
  OPTION_ACTIVATE_ITEM_DELETE_PROTECTION:          {ID:'OPTION_ACTIVATE_ITEM_DELETE_PROTECTION'             ,DEFAULT:''},
  ...
  OPTION_USE_CITEM_INFO_FORM_FOR_GMS:              {ID:'OPTION_USE_CITEM_INFO_FORM_FOR_GMS'                 ,DEFAULT:''},
